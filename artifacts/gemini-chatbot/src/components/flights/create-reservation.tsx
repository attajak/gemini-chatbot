...
const SAMPLE = {
  seats: ["4C"],
  flightNumber: "EK413",
  departure: { cityName: "Sydney", airportCode: "SYD", timestamp: "2023-11-01T06:00:00", gate: "A12", terminal: "1" },
  arrival: { cityName: "Chennai", airportCode: "MAA", timestamp: "2023-11-01T18:45:00", gate: "B5", terminal: "3" },
    ...
    <div className="rounded-lg bg-muted p-4">
      <div className="flex flex-col justify-between gap-4">
        <div className="text font-medium">
          <span className="text-foreground/50">Continue purchasing this reservation from </span>
          {reservation.departure.cityName} to {reservation.arrival.cityName}
          <span className="text-foreground/50"> at </span>
          <span className="text-emerald-600 font-medium">${reservation.totalPriceInUSD} USD<span className="text-foreground/50">?</span></span>
        </div>
